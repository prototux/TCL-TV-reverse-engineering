// libfpp sandbox, this is a very messy file!
#include <stdio.h>
#include <stdlib.h>
#include <inttypes.h>
#include <string.h>
...
// update: it doesn't crash anymore with this stbc_data
...
struct tag_video_adjustment_item_t test_brightness = {
    .n8_value = 255,
    .n8_min = 255,
    .n8_low = 255,
    .n8_mid = 255,
	...
	// Activate or desactivate the backlight, boolean parameter
	fpp_power_set_backlight(1);

	// I can't do this because of "MIX_ADJUST_BACKLIGHT_ENABLE"
	//fpp_video_set_background_light(50,51);

	// Set brightness using a video_adjustement_item
	// I have no idea what the first parameter is for,
	// But it's always 0
	fpp_video_set_brightness(1, &test_brightness);
